...
🔍 *Что я умею:*
• Объясняю парфюмерные термины
• Разбираю жаргон и сленг
• Помогаю понять структуру ароматов
• Отвечаю на вопросы о концентрациях
...
• Предлагайте новые термины для словаря
        ...
        # Убираем любую старую постоянную клавиатуру
        await update.message.reply_text(
            "✨ Готово! Используйте кнопки выше или просто напишите термин для поиска.",
